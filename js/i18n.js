...
(function() {
  ...
  const translations = {
    en: {
      ...
      bk_s1_title: 'Your Contact Details',
      bk_s1_desc: 'Please log in with your details or continue as a guest. We\'ll use this information to confirm your booking.',
      ...
      bk_next3: 'Review Booking →',
      bk_s4_title: 'Confirm Your Booking',
      bk_s4_desc: 'Please review your booking details below before confirming.',
    ...
    ru: {
      ...
      bk_s1_title: 'Ваши контактные данные',
      bk_s1_desc: 'Войдите или продолжите как гость — мы используем эту информацию для подтверждения заказа.',
      ...
      bk_next3: 'Проверить заказ →',
      bk_s4_title: 'Подтвердите заказ',
      bk_s4_desc: 'Проверьте детали заказа перед подтверждением.',
    ...
    tr: {
      ...
      bk_s1_title: 'İletişim Bilgileriniz',
      bk_s1_desc: 'Giriş yapın veya misafir olarak devam edin — bu bilgileri rezervasyonunuzu onaylamak için kullanacağız.',
      ...
      bk_next3: 'Rezervasyonu İncele →',
      bk_s4_title: 'Rezervasyonu Onayla',
      bk_s4_desc: 'Onaylamadan önce rezervasyon bilgilerinizi inceleyin.',
    ...
    es: {
      ...
      bk_s1_title: 'Tus Datos de Contacto',
      bk_s1_desc: 'Inicia sesión o continúa como invitado — usaremos esta información para confirmar tu reserva.',
      ...
      bk_next3: 'Revisar Reserva →',
      bk_s4_title: 'Confirma tu Reserva',
      bk_s4_desc: 'Por favor revisa los detalles de tu reserva antes de confirmar.',

...
(function() {
  ...
  const translations = {
    en: {
      ...
      bsvc3_desc: 'Full property clean', bsvc4_desc: 'Commercial spaces',
      bsvc5_desc: 'Interior & exterior', bsvc6_desc: 'Steam & deep clean',
    ...
    ru: {
      ...
      bsvc3_desc: 'Полная уборка объекта', bsvc4_desc: 'Коммерческие помещения',
      bsvc5_desc: 'Снаружи и изнутри', bsvc6_desc: 'Паровая и глубокая чистка',
    ...
    tr: {
      ...
      bsvc3_desc: 'Tam mülk temizliği', bsvc4_desc: 'Ticari alanlar',
      bsvc5_desc: 'İç ve dış mekan', bsvc6_desc: 'Buharlı ve derin temizlik',
    ...
    es: {
      ...
      bsvc3_desc: 'Limpieza completa del inmueble', bsvc4_desc: 'Espacios comerciales',
      bsvc5_desc: 'Interior y exterior', bsvc6_desc: 'Vapor y limpieza profunda',

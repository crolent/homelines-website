...
(function() {
  ...
  const translations = {
    en: {
      ...
      bk_s1_desc: 'Enter your email to book your cleaning. No account needed.',
    ...
    ru: {
      ...
      bk_s1_title: 'Начало',
      bk_s1_desc: 'Введите email, чтобы забронировать уборку. Аккаунт не нужен.',
    ...
    tr: {
      ...
      bk_s1_desc: 'Temizlik rezervasyonu yapmak için e-posta adresinizi girin. Hesap gerekmez.',
    ...
    es: {
      ...
      bk_s1_desc: 'Ingresa tu email para reservar tu limpieza. No necesitas cuenta.',
